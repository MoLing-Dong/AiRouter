...
class BaseTransactionManager:
    """Base transaction manager with common functionality"""
    ...
    def execute_in_transaction(
        self, operation: Callable[[Session], T], description: str = "Database operation"
    ) -> T:
        """
        在事务中执行操作
...
class DatabaseTransactionManager(BaseTransactionManager):
    ...
    def execute_batch_operation(
        ...
        return self.execute_in_transaction(batch_operation, description)
