...
stats_router = APIRouter(prefix="/v1/stats", tags=["Stats Management"])
...
async def get_routing_stats():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Get statistics information failed: {str(e)}")
...
async def reset_stats():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Reset statistics failed: {str(e)}")
...
async def refresh_config():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Refresh configuration failed: {str(e)}")
